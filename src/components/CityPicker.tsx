...
export default function CityPicker(props: ICityPickerProps) {
  return (
    <div className={`flex flex-row items-center ${props.className}`}>
      ...
      <div className="w-2/3">
        <select
          className="bg-gray-200 border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-yellow-500"
          value={props.value}
